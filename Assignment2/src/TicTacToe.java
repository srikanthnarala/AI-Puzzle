...
public class TicTacToe{
    public static void main(String[] args) { 
        ...
        System.out.println("Who should start first? (1)Computer (2)User: ");
        ...
        while (!b.isGameOver()) {
            ...
            System.out.println("\nThe number of childs created are : " +b.count);
            b.count=0;
        ...
        if (b.hasXWon()) {
            ...
            System.out.println("Thats a draw!...how about one more game?");
        }
    }
